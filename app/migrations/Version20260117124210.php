...
final class Version20260117124210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE surveys (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, draft BOOLEAN NOT NULL, slug VARCHAR(255) NOT NULL, password_required BOOLEAN NOT NULL, password VARCHAR(255) DEFAULT NULL, extra_options CLOB NOT NULL, public_at DATETIME NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL)');
