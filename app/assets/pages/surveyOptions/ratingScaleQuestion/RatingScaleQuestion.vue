...
import { ArrowBigUp, ArrowBigDown, Trash2, Eye, EyeOff, ListChecks } from 'lucide-vue-next';
import Btn from '../../../components/Btn.vue';
import RatingScaleQuestionOptions from './RatingScaleQuestionOptions.vue';
...
const isMinOptionsLimitError = (): boolean => {
    return props.question.minOptionsLimit > props.question.maxOptionsLimit;
}

const isMaxOptionsLimitError = (): boolean => {
    return props.question.maxOptionsLimit < props.question.minOptionsLimit;
}
...
<template>
    ...
    >
        ...
        <div class="grid gap-2 p-2">
            ...
            <div v-if="errors?.optionsEmpty" class="px-4 pt-4 text-xs text-red-500">The list of subqueries cannot be empty</div>
            <RatingScaleQuestionOptions :options="question.options" />
        </div>
    </div>
